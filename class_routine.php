<div class="row">
   ...
   <div class="col-sm-5">  
      <select name="time_start_hour" class="form-control" style="width:100%;">  
        <?php for($i = 0; $i <= 12 ; $i++):?>  
           <option value="<?php echo $i;?>"><?php echo $i;?></option>  
        <?php endfor;?>  
      </select>  
      <select name="time_start_minute" class="form-control" style="width:100%;">  
        <?php for($i = 0; $i <= 59 ; $i++):?>  
...
<div class="form-group">  
   ...
   <div class="col-sm-5">  
      <select name="time_end_hour" class="form-control" style="width:100%;">  
        <?php for($i = 0; $i <= 12 ; $i++):?>  
           <option value="<?php echo $i;?>"><?php echo $i;?></option>  
        <?php endfor;?>  
      </select>  
      <select name="time_end_minute" class="form-control" style="width:100%;">  
        <?php for($i = 0; $i <= 59 ; $i++):?>  
           <option value="<?php echo $i;?>"><?php echo str_pad($i, 2, '0', STR_PAD_LEFT);?></option>  
        <?php endfor;?>  
      </select>  
